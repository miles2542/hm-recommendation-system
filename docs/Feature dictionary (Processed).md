...
| `customer_id` | Int32 | 0.00% | [0, 1,371,979] | 512 | Mapped Customer ID |
| `article_id` | Int32 | 0.00% | [0, 105,541] | 2048 | Mapped Article ID |
...
| `days_ago` | Int64 | 0.00% | [0, 733] | 733 | Days since global max date |
| `time_weight` | Float64 | 0.00% | [0.0, 1.0] | 0.00000004 | Exp decay weight (30d half-life) |
...
| `age` | Int8 | 0.00% | [16, 99] | 49 | Customer age (Affinitive Imputation) |
